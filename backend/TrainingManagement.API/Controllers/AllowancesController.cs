...
public class AllowancesController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<PaginatedResponse<AllowanceResponseDto>>> GetAll(
    ...
    public async Task<ActionResult<AllowanceResponseDto>> Create([FromBody] CreateAllowanceDto dto)
    {
        var a = new Allowance
        {
            ...
            AdmissionFK = dto.AdmissionId,
            AllowanceTypeFK = dto.AllowanceTypeId,
            StatusFK = dto.StatusId,
            Amount = dto.Amount,
